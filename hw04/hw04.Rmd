...
training_trans <- data.frame(sapply(inputs_num,function(x){capColumn(x,training_trans)}))
evaluation_trans <- data.frame(sapply(inputs_num,function(x){capColumn(x,evaluation_trans)}))
