...
target_flag_model_all <- glm(TARGET_FLAG~.,data=training_target_flag[,c(inputs,target_bin)])
summary(target_flag_model_all)
...
```{r}
inputs_manual_flag <- inputs[-c(4,5,7,8,11,13,15,23,26,28,30)]
target_flag_model_all <- glm(TARGET_FLAG~.,data=training_target_flag[,c(inputs_manual_flag,target_bin)])
summary(target_flag_model_all)
