...
```{r,message=FALSE}
require("pROC")
d_roc <- roc(d$class,d$scored.class)
plot(d_roc)
ci(d_roc)

# can use the following to compare this roc with our own from part 10.
# roc.test(d_roc, personal)
```

Let's plot this prettier somehow.